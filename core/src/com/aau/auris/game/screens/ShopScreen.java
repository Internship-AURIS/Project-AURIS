...
public class ShopScreen extends AbstractScreen {
	...
	protected void initComponents() {
		...
		final int s_width = Gdx.graphics.getWidth(), s_height = Gdx.graphics
				.getHeight();// screen dimension
...
//		shopItem1.add(shopItem1.getLabel());
	...
	public void render(float delta) {
		...
		batch.begin();
		batch.draw(currentFrame, game.getWidth() / 2 - game.getWidth() / 5.3f
				- 25, game.getHeight() / 2 - game.getHeight() / 6.3f, 100, 100);
		batch.end();
